DamagelogLang.english = {
    ...
    UpdateNotify = "This version is outdated! You can get the latest one on https://github.com/BadgerCode/tttdamagelogs",
    About = "About",
    Settings = "Settings",
    ...
    ShotLogsDamageTab = "Show shot logs next to the damage tab",
    ...
    webhook_report_forgiven = "Forgiven",
