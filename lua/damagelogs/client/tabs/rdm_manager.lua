    ...
    if serverguard or sam or ulx then
        if serverguard or sam or (ulx and (mode == 1 or mode == 2)) then
            ...
            if Damagelog.AllowBanningThruManager then
                ...
                slaynr_pnl2:SetText(TTTLogTranslate(GetDMGLogLang, "rdmmanager_action_ban"))
...
function PANEL:PaintOver(w, h)
    ...
    surface.DrawLine(self.Distance / 2 - 5, self.Dimension / 2.5 + 5, self.Distance * 4.85, self.Dimension / 2.5 + 5)
